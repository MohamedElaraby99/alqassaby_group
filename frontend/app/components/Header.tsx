        ...
        <div className="flex justify-between items-center py-3 sm:py-4">
          ...
          >
            <svg
              ...
              className={`h-8 sm:h-10 md:h-12 w-auto transition-colors duration-300 ${locale === 'en' ? '-mr-[124px] md:-mr-[188px]' : ''}`}
            >
              <g>
                <path 
                  className="transition-colors duration-300" 
                  fill={isScrolled ? '#fde047' : 'white'}
            ...
            <div className="text-sm sm:text-lg md:text-2xl font-bold">
              <span
                className={`transition-colors duration-300 whitespace-nowrap drop-shadow-md ${
          ...
          <div className="hidden lg:flex items-center gap-6 xl:gap-8">
            ...
            <div className="relative">
              <button
                ...
                className={`group flex items-center gap-2 px-5 py-2.5 bg-white/20 hover:bg-white/30 backdrop-blur-md border border-white/30 hover:border-white/50 rounded-full font-bold text-sm transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 ${
                  isScrolled ? 'text-[#fde047]' : 'text-white'
                }`}
              >
